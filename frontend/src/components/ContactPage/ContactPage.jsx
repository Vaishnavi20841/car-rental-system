          ...
          <div className={styles.infoCard}>
            ...
            <div className="relative z-10 space-y-5">
              ...
              <div className={styles.infoItemContainer}>
                {[
                  { icon: FaWhatsapp, label: 'WhatsApp', value: '+91 123456789', color: 'bg-green-900/30' },
                  { icon: FaEnvelope, label: 'Email', value: 'UrbanRideServices@gmail.com', color: 'bg-orange-900/30' },
