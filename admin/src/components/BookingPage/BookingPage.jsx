...
const BackgroundGradient = () => (
  <div className={BookingPageStyles.fixedBackground}>
    <div className={BookingPageStyles.gradientBlob1} />
    <div className={BookingPageStyles.gradientBlob2} />
    <div className={BookingPageStyles.gradientBlob3} />
  </div>
);
...
const PageHeader = () => (
  <div className={BookingPageStyles.headerContainer}>
    <div className={BookingPageStyles.headerDivider}>
      <div className={BookingPageStyles.headerDividerLine} />
    </div>
